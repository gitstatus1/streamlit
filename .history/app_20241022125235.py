...
with st.container(border=True): #key = Image Generation Project
    ...
    with left_col:
        ...
        st.markdown('''
                    <p class="text">
                    This project uses ControlNet to generate images with ControlNet is a neural network used in conjunction with the Stable Diffusion model to condition image generation with and added complexity.
