...
with st.container(border= True): #key= "Tank Pressure"
    ...
    with left_col:
        ...
        st.markdown('''
                    ...
                    techniques (neural network, random forest). After developing the machine learning models, the goal of the project aims to provide explainable and interpretable insights of impact of different features on the target variable.
                    </p>
                    ''',
                      unsafe_allow_html=True)
        st.write("##")
