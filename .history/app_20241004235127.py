...
with st.container():
    ...
    with left_col:
        ...
        st.markdown('''
                    <p class="text">
                    ControlNet is a neural network used in conjunction with the Stable Diffusion model to condition image generation
                    A fun image generation project utilizing advanced AI techniques to create customized visuals based on user inputs.
                    </p>
                    ''',
                      unsafe_allow_html=True)
        st.write("[Project Link](https://colab.research.google.com/drive/1MNslw2EyoMf1QSsPnBT_FaGDAYhRBbkD?usp=sharing)")
    right_col.image("controlnet.png")
