...
with st.container(): #key = "top container"
    ...
    with col2:
        st_lottie(robot_gif, key = 'robot', height = 400)
...
with st.container(): #key= "Tank Pressure"
    left_col, right_col = st.columns(2)
    with left_col:
        st.subheader("Tank Pressure Preidction")
        st.markdown('''
                    <p class="text">
                    ...
                    After developing the machine learning models, the goal of the project aims to provide
                    explainable and interpretable insights of impact of different features on the target variable
                    </p>
                    ''',
                      unsafe_allow_html=True)
        st.write("##")
        st.write("[✨See Project Link✨](https://colab.research.google.com/drive/1-FdBnXT1b5TipWuWlfAq5H2NZVTz0sx4?usp=sharing)")
    right_col.image("controlnet.png", caption='Transforming "The Great Wave" artwork into different styles', width = 400)
