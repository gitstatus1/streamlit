...
with st.container(): #key= "Tank Pressure"
    ...
    with left_col:
        ...
        st.markdown(f'<p class="text">[✨See Project Link✨](https://colab.research.google.com/drive/1-FdBnXT1b5TipWuWlfAq5H2NZVTz0sx4?usp=sharing)</p>' )
    st.markdown(
    f'<p style="font-size:20px;">✨<a href="https://colab.research.google.com/drive/1-FdBnXT1b5TipWuWlfAq5H2NZVTz0sx4?usp=sharing" target="_blank">See Project Link✨</a></p>',
    unsafe_allow_html=True)
