...
st.markdown("<style>.title{font-size:85px !important;}</style>", unsafe_allow_html=True)
...
with st.container(): #key = "top container"
    ...
    with col1:
        st.markdown('<div style="text-align:center"><p class="title">Hi, I am Eric</p></div>', unsafe_allow_html= True)
        st.markdown('<div style="text-align:center"><p class="subtitle"><strong>Data and AI Enthusiast</strong></p></div>', unsafe_allow_html=True)      
        st.markdown('''<div style="text-align:justify"><p class="text">I am passionate about harnessing data science and AI to solve real-world problems and improve quality of life. 
                I am driven by the potential of technology to innovate across industries and create meaningful impact in the society.</p></div>''', unsafe_allow_html= True)
        st.markdown('''<div style="text-align:justify"><p class="text">
            ...
            I like playing around with AI technology and work on fun projects. Please have a look!</p></div>''', unsafe_allow_html=True)
...
with st.container(border=True): #key = Image Generation Project
    ...
    with left_col:
        ...
        st.markdown('''
                    <div style="text-align:justify"><p class="text">
                    This project uses ControlNet to generate images with special conditions. ControlNet is a neural network used in conjunction with the Stable Diffusion model to condition image generation with and added complexity.
                    ...
                    See example figure example on the right transforming a well-known painting into different styles.
                    </p></d>
                    ''',
...
with st.container(border= True): #key= "Bollinger Bands"
    left_col, right_col = st.columns(2, gap = "large")
    with left_col:
        st.subheader("Stock Bollinger Band Simulation")
        st.markdown('''
                    <div style="text-align:justify"><p class="text">
                    A project is simulating a trading strategy using Bollinger Bands for a specific stock over a minute-by-minute interval. 
