...
with st.container(): #key = "top container"
    ...
    with col1:
        ...
        st.markdown('''div style="text-align:left"><p class="text">I am passionate about harnessing data science and AI to solve real-world problems and improve quality of life. 
