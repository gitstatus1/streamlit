...
st.markdown("<style>.subheader{font-size:25px !important;}</style>", unsafe_allow_html=True)
st.markdown("<style>.title{font-size:75px !important;}</style>", unsafe_allow_html=True)
