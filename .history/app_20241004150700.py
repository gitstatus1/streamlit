...
with st.container():
    ...
    with col2:
        ...
        st.write("I’m passionate about harnessing Data Science and AI to solve real-world problems and improve quality of life. Im driven by the potential of technology to innovate across industries and create meaningful impact")
