...
with st.container(border= True): #key= "Tank Pressure"
    ...
    with left_col:
        ...
        st.markdown('''
                    <p class="text">
                    A regression project focused on predicting the target pressure of a tank based on various input features using statistical (linear regression) and machine learning
