...
with st.container():
    ...
    with left_col:
        ...
        st.markdown('''
                    <p class="text">A fun image generation project utilizing advanced AI techniques to create customized visuals based on user inputs.</p>', unsafe_allow_html=True)
