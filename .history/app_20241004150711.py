...
with st.container():
    ...
    with col2:
        ...
        st.write("I am passionate about harnessing Data Science and AI to solve real-world problems and improve quality of life. I am driven by the potential of technology to innovate across industries and create meaningful impact")
