...
with st.container():
    ...
    with col2:
        ...
        st.markdown('<p class="subheading">As a problem solver with a keen eye for detail, I approach challenges by uncovering patterns and insights within data. Levering the power of AI and  </p>', unsafe_allow_html=True)
