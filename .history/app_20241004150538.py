...
#Set up the webpage 
st.set_page_config(page_title = "Eric Webpage", page_icon= ":black_square_button:", layout = 'wide')
#load css
...
with st.container():
    ...
    with col2:
        ...
        st.write("I am passionate about finding ways to incorporate Data Science and AI in the industry to improve quality of life and [something]")
