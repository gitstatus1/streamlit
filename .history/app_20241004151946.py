...
with st.container():
    ...
    with col2:
        ...
        st.markdown('<p class="subheading">[✨My LinkedIn✨](https://www.linkedin.com/in/ericlau2000/)</p>', unsafe_allow_html= True)
        st.markdown('<p class="subheading">[✨My LinkedIn✨](https://www.linkedin.com/in/ericlau2000/)<>')
