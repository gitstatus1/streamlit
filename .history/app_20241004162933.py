...
with st.container():
    ...
    with left_col:
        st.header("What I Do")
        st.markdown('<p class="subheading">As a problem solver with a keen eye for detail, I approach challenges by uncovering patterns and insights within data. Levering the power of AI and analytics, data can be transformed into compelling narratives and help organisations innovate.</p>', unsafe_allow_html=True)
